...
function Community() {
  return (
    <div className="w-full min-h-full bg-black flex justify-center px-1 sm:px-5 py-20">
      <div className="max-w-4xl xl:max-w-6xl flex flex-col md:flex-row justify-center items-center space-x-5">
        ...
        <div className="max-w-sm space-y-2.5 text-white">
          ...
          <p className="xl:text-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla morbi et mi turpis ullamcorper.</p>
          <div className="flex">
