  ...
  return (
    <div className="bg-black flex justify-center max-h-full py-10">
      <div className="max-w-6xl flex flex-col items-center text-white space-y-4 px-2.5">
        <h3 className="text-2xl md:text-4xl font-semibold">Product Offering</h3>
        <h4 className="text-lg md:text-2xl max-w-2xl text-center">Bankless Research Report offering incorporates all components that you need to make smart decisions, including:</h4>
