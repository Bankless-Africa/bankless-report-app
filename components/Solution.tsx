...
function Solution() {
  ...
  return (
    <div className="flex justify-center items-center bg-black max-h-full text-white p-5">
        <div className="max-w-4xl xl:max-w-6xl flex flex-col lg:flex-row justify-between space-x-5 xl:py-10">
            <div className="flex-1 flex flex-col items-start justify-start text-left space-y-2 xl:space-y-5">
                <h2 className="text-3xl xl:text-5xl font-semibold">What Solution is Bankless Research giving?</h2>
                <p className="text-lg xl:text-3xl">A research report that makes navigating Web3 feel easy again</p>
